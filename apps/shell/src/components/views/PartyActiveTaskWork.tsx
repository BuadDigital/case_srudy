...
import type { EvaluatorWindowHostRef } from "@/lib/prototype/evaluator/evaluator-window-host";
import type { PartyActiveTaskWorkHostRefObject } from "@/lib/prototype/party-active-task-work-host";
import { FieldFormView } from "@/components/views/FieldFormView";
import { RegistrationFormCard } from "@platform/app-shared/registration/RegistrationFormCard";
import { TaskWorkChrome } from "@case-study/mfe";
import {
  formatPoDisplay,
  formatPropertyDeedDisplay,
} from "@case-study/mfe";
import { usePoRecordQuery, useWorkflowTasksQuery } from "@/lib/query/prototype-queries";
import {
  isEvaluatorFormLocked,
  loadEvaluatorSubmission,
} from "@/lib/prototype/evaluator/evaluator-submission-storage";
import type { PartyTaskPageDef } from "@platform/app-shared/prototype/party-task-pages";
import { partyTaskPath } from "@case-study/mfe";
import {
  completeChildTask,
...
export function PartyActiveTaskWork({
  ...
  const evaluatorHostRef = useRef<EvaluatorWindowHostRef>({});
