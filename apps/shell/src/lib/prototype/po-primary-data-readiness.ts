import { hasFieldErrors } from "@/components/prototype/registration/registration-utils";
import { mergePropertyEnfathValidation } from "@/lib/domain/po-intake/property-enfath-validation";
